        ...
        <footer className="bg-gradient-to-b from-gray-900 to-black text-gray-400 mt-auto pb-20">
            ...
            <div className="max-w-6xl mx-auto px-4 pt-10 pb-6">
                ...
                <div className="border-t border-white/5 pt-5 flex flex-col sm:flex-row justify-between items-center gap-3">
                    <p className="text-[10px] text-center sm:text-left text-gray-600">
                        &copy; 2024 upx365. All rights reserved. Gambling involves risk. 18+ only. Please gamble responsibly.
                    </p>
                    <div className="flex items-center gap-4 text-[10px] text-gray-600">
                        <button onClick={() => onLegalClick('terms')} className="hover:text-gray-400 transition-colors">Terms</button>
                        <span className="w-px h-3 bg-white/10"></span>
                        <button onClick={() => onLegalClick('privacy')} className="hover:text-gray-400 transition-colors">Privacy</button>
                        <span className="w-px h-3 bg-white/10"></span>
                        <button onClick={() => onLegalClick('responsible-gaming')} className="hover:text-gray-400 transition-colors">Responsible Gaming</button>
                    </div>
                </div>
            </div>
        </footer>
